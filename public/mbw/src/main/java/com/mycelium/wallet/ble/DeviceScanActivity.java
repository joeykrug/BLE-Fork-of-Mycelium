...
public class DeviceScanActivity extends ListActivity {
   ...
   protected void onListItemClick(ListView l, View v, int position, long id) {
       ...
       intent.putExtra("spendable", _spendable);
       intent.putExtra("oneBtcInFiat", _oneBtcInFiat);
       intent.putExtra("amountToSend", _amountToSend);
       intent.putExtra("receivingAddress", _receivingAddress);
       intent.putExtra("isColdStorage", _isColdStorage);
       if (mScanning) {
    ...
    private void scanLeDevice(final boolean enable) {
        if (enable) {
            ...
            mScanning = true;
            // search for devices with this uuid service in specific
             //  UUID[] uuidArray = new UUID[1];
             //  uuidArray[0] = UUID.fromString("230f04b4-42ff-4ce9-94cb-ed0dc8238447");
